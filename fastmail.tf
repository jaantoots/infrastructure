...
locals {
  mx_names = ["*", "${cloudflare_zone.jaan_xyz.zone}", "mail", "www", "cloud"]
}
...
resource "cloudflare_record" "fm1_domainkey" {
  ...
  name    = "fm1._domainkey"
  type    = "CNAME"
  value   = "fm1.${cloudflare_zone.jaan_xyz.zone}.dkim.fmhosted.com"
}
...
resource "cloudflare_record" "fm2_domainkey" {
  ...
  name    = "fm2._domainkey"
  type    = "CNAME"
  value   = "fm2.${cloudflare_zone.jaan_xyz.zone}.dkim.fmhosted.com"
}
...
resource "cloudflare_record" "fm3_domainkey" {
  ...
  name    = "fm3._domainkey"
  type    = "CNAME"
  value   = "fm3.${cloudflare_zone.jaan_xyz.zone}.dkim.fmhosted.com"
}
...
resource "cloudflare_record" "mesmtp_domainkey" {
  ...
  type    = "CNAME"
  value   = "mesmtp.${cloudflare_zone.jaan_xyz.zone}.dkim.fmhosted.com"
}
